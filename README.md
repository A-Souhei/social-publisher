...
A [Hermes agent](https://hermes-agent.nousresearch.com/) plugin for creating and publishing content to LinkedIn Pages and Facebook, with AI image generation, image enhancement, and post scheduling.

## Features

- **Publish** to LinkedIn pages and Facebook pages
...
| `LINKEDIN_ACCESS_TOKEN` | LinkedIn Developer App OAuth 2.0 token with `w_organization_social` scope |
